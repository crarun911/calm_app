            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      _QuickAction(emoji: '🌬️', label: 'Breathe', color: AppTheme.sage,
                        onTap: () => Navigator.pushNamed(context, '/breathe')),
                      const SizedBox(width: 10),
                      _QuickAction(emoji: '🌙', label: 'Sleep', color: AppTheme.lavender,
                        onTap: () => Navigator.pushNamed(context, '/sleep')),
                      const SizedBox(width: 10),
                      _QuickAction(emoji: '🧘', label: 'Meditate', color: AppTheme.gold,
                        onTap: () => Navigator.pushNamed(context, '/meditate')),
                      const SizedBox(width: 10),
                      _QuickAction(emoji: '😊', label: 'Mood', color: AppTheme.rose,
                        onTap: () => Navigator.push(context,
                          MaterialPageRoute(builder: (_) => const MoodCheckInScreen()))),
                    ],
                  ),
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 12),
                  const Text('Begin your practice',
                    style: TextStyle(color: AppTheme.sageLight, fontSize: 13, fontWeight: FontWeight.w500)),
                ],
              ),
            ],
          ),
